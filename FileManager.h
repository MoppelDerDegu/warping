...
struct FileManager
{
	...
	static void savePathlines(const string &fileName, const string &dir, const vector<Pathline> &pathlines);
	static vector<Pathline> loadPathlines(const string &fileName);
};